...
<div class="wrapper">
  ...
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="./admin/admin.jpg" alt="Admin Image">
    </div>

    <div class="profile-card__cnt js-profile-cnt">
      <div class="profile-card__name">K.N.V.Durga Prasad (Bobby)</div>
      <div class="profile-card__txt">3<sup>rd</sup> B.Tech from <strong>DNR College of Engineering and Technology</strong></div>
      ...
      <div class="profile-card-inf">
        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">9542109121, 6300807459</div>
          <div class="profile-card-inf__txt">Contact</div>
        </div>
      ...
      <div class="profile-card-social">
        <a href="mailto:knvdurgaprasd610@gmail.com?Subject=Hello%20Bobby" target="_top" class="profile-card-social__item facebook" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-facebook"></use></svg>
          </span>
        </a>

        <a href="https://twitter.com/prasadbobby610" class="profile-card-social__item twitter" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-twitter"></use></svg>
          </span>
        </a>

        <a href="https://www.instagram.com/___mr_introvert____/" class="profile-card-social__item instagram" target="_blank">
          <span class="icon-font">
        ...
        <a href="https://github.com/prasadbobby" class="profile-card-social__item github" target="_blank">
          <span class="icon-font">
        ...
        <a href="http://edumaterials.tech/" class="profile-card-social__item link" target="_blank">
          <span class="icon-font">
      ...
      <div class="profile-card-ctr">
        ...
        <button class="profile-card__button button--orange" onclick="window.open('https://api.whatsapp.com/send?phone=+919542109121&text=Hi%2C%20Bobby..!%20I%20need%20a%20Help.')" />Whatsapp</button>
      </div>
    </div>

    <div class="profile-card-message js-message">
      <form id="my-form" action="https://formspree.io/mzbalabw" method="POST" class="profile-card-form">
        <div class="profile-card-form__container">
          <textarea placeholder="Say something include Email...." name="message"></textarea>
        </div>

        <div class="profile-card-form__bottom">
          <button class="profile-card__button button--blue" id="my-form-button">
            Send
          </button>
    ...
    <p >
      <div class="alert hide" id="my-form-status">
        <span class="fas fa-check"></span>
        <span class="msg">Thank you: Successfully msg sent!</span>
        <div class="close-btn">
...
<svg hidden="hidden">
  <defs>
    ...
    <!-- <symbol id="icon-facebook" viewBox="0 0 32 32">
      ...
      <g>
              <g>
                <path d="M410.272,243.145c-3.63-4.486-10.211-5.179-14.695-1.548l-3.636,2.942c-4.485,3.631-5.177,10.211-1.546,14.696
            ...
            <g>
              <g>
                <path d="M380.363,267.357c-3.63-4.486-10.211-5.179-14.695-1.549l-74.708,59.674c-4.485,3.631-5.177,10.21-1.546,14.695
            ...
            <g>
              <g>
                <path d="M449.742,62.685H62.258C27.929,62.685,0,90.614,0,124.942v262.117c0,34.329,27.929,62.257,62.258,62.257h387.484
...
<script>
    ...
    <script type="text/javascript">
      // const phrases = ['K.N.V.Durga Prasad (Bobby)'];
      // const el = document.queryselector('.profile-card__name');
    ...
    <!-- <script type="text/javascript" src="admin/scramble.js"></script> -->
