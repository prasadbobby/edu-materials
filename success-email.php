...
<head>
	...
	<title>EDU Materials -The power of knowledge</title>
...
<img alt="EDU Materials Logo" src="https://res.cloudinary.com/prasadbobby6100/image/upload/v1589460981/Edu_Materials-01_wi0uyq.png" width="150">
</a>
</td>
</tr>
<tr>
...
<img alt="Welcome to EDU Materials" src="https://res.cloudinary.com/prasadbobby6100/image/upload/v1589301536/21665-web-flow_trp565.gif" width="400">
<br>
<br>
 Hi <?php echo $name; ?> ,
<br>
<br>
Congratulations! You&#39;re almost set to start using EDU Materials.
<br>
Just click the button below then login to your Dashboard.
...
<a href="http://edumaterials.tech/login" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;padding:20px;color:#fff;text-decoration:none;display:block" target="_blank">Sign in to EDU Materials
</a>
</td>
</tr>
</table>
...
<br>
<br>
If you encounter any problem, please contact us at <a href="mailto:admin@edumaterials.tech" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;font-size:14px;font-weight:normal" target="_blank">admin@edumaterials.tech</a>.
</div>
</td>
</tr>
<tr>
<td style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;padding:20px 40px">
...
<td style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px">
<a href="mailto:knvdurgaprasad610@gmail.com" target="_blank">knvdurgaprasad610@gmail.com</a>
</td>
</tr>
<tr>
<td style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px">
...
What&#39;s Next?
<ul>
<li style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;padding:10px 0">Learn about the features and see API references in our <a href="#" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4" target="_blank">Documentation</a>.</li>
<li style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;padding:10px 0">Check out our <a href="#" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4" target="_blank">Blog</a> for news, updates and samples.</li>
<li style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;padding:10px 0">Visit <a href="#" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4" target="_blank">our support center</a> for some helpful answers and discussions.</li>
<li style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;padding:10px 0">Impact our <a href="#" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4" target="_blank">Roadmap</a> and learn about upcoming features and releases!</li>
</ul>
</h3>
</td>
</tr>
...
<tr>
<td align="center" style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;color:#000">
Impact the E-Books, hear updates, Online Compiler and more!
...
<a href="http://edumaterials.tech/compiler" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;padding:12px;color:#fff;text-decoration:none;display:block" target="_blank">
Online Compiler!
</a>
</td>
</tr>
...
Spread the word to world
</td>
</tr>
<tr>
<td align="center" style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;color:#000">
Tell your friends about EDU Materials and learn new things your freinds too.
<table align="center" cellpadding="0" cellspacing="0" style="margin:0 auto;padding:20px">
<tr>
<td align="center" bgcolor="#005CE4" style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;font:500 16px/18px Arial,Helvetica,sans-serif,Fira;letter-spacing:.4px;border-radius:2px">
<a href="http://edumaterials.tech/login" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;padding:12px;color:#fff;text-decoration:none;display:block" target="_blank">
Login please!
</a>
</td>
</tr>
...
<tr>
<td width="52" style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;width:44px">
<a href="#" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4" target="_blank">
<img alt="Ico-community" src="https://cloudinary-res.cloudinary.com/image/upload/w_33,dpr_2.0/v1513241200/mail/ico-community.png" style="width:32px;width:38px;vertical-align:top" width="38">
</a>
</td>
<td style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;line-height:18px;font-size:13px;font:14px/18px Arial,Helvetica,sans-serif,Fira;color:#0e2f5a;white-space:nowrap">
<a href="http://edumaterials.tech/ourteam" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;color:#0e2f5a;text-decoration:none" target="_blank">Our Team!</a>
</td>
<td width="35" style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px">
  
</td>
<td width="49" style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;width:40px">
<a href="#" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4" target="_blank">
<img alt="Training" src="https://cloudinary-res.cloudinary.com/image/upload/w_33,dpr_2.0/v1513241200/mail/icon-webinar.png" style="width:32px;width:33px;vertical-align:top" width="4 0">
</a>
</td>
<td style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;line-height:18px;font-size:13px;font:14px/18px Arial,Helvetica,sans-serif,Fira;color:#0e2f5a;white-space:nowrap">
<a href="http://edumaterials.tech/about" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;color:#0e2f5a;text-decoration:none" target="_blank">About</a>
</td>
</tr>
</table>
</th>
...
<a href="#" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;text-decoration:none" target="_blank">
<img alt="EDU Materials Logo" src="https://res.cloudinary.com/prasadbobby6100/image/upload/v1589297037/edu_d9dla0.png" style="width:54px;font:14px Arial,Helvetica,sans-serif;vertical-align:top" width="54">
</a>
</td>
</tr>
<tr>
...
© 2020 EDU Materials. All rights reserved.<br>
You are receiving this email because you registered for EDU Materials.
<br>Designed and Developed by<br> K.N.V.Durga Prasad (Bobby), 9542109121

</td>
</tr>
<tr>
<td align="center" style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px;font:500 12px/17px Arial,Helvetica,sans-serif,Fira;color:#0078ff">
<a href="http://edumaterials.tech/contact" style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;color:#0078ff;text-decoration:underline" target="_blank">Contact Us</a>
</td>
</tr>
</table>
</td>
...
<td bgcolor="#005CE4" height="150" style="font-family:Helvetica,Arial,Helvetica,sans-serif;color:#111111;font-size:14px;line-height:18px"></td>
		...
		<script type="text/javascript" nonce="Iz4tWTWCC9Y6aifObDnU9g">
			// <![CDATA[
