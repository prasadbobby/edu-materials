...
<div class="container-fluid">
   ...
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">OOAD UNIT - II Preview</h1>
   </div>
   <div class="card shadow mb-4">
      ...
      <div class="card-body text-center">
         ...
         <div class="embed-responsive embed-responsive-1by1">
            <div>
               <iframe src="https://drive.google.com/file/d/1BIVBZ9euCiGawaFNqWAFAYbzqJaxXWuz/preview" width="80%" height="480"
...
function onClick(){
   window.location.href ="https://drive.google.com/u/0/uc?id=1BIVBZ9euCiGawaFNqWAFAYbzqJaxXWuz&export=download"
}
